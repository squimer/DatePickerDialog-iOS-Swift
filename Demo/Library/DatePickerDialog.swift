...
class DatePickerDialog: UIView {
    ...
    func deviceOrientationDidChange(notification: NSNotification) {
        //maintains the datepicker dialog view but the selected date is not set, sets to default date
        createContainerView()
        dialogView.center = CGPoint(x: UIScreen.mainScreen().bounds.midX, y: UIScreen.mainScreen().bounds.midY)
        dialogView.autoresizingMask = [
            .FlexibleLeftMargin,
            .FlexibleRightMargin,
            .FlexibleTopMargin,
